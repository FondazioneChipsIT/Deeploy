...
from Deeploy.Targets.PULPOpen_iDMA.Platform import MemoryPULPPlatform_iDMA, PULPPlatform_iDMA
...
_NONSIGNPROP_PLATFORMS = ["Siracusa", "Siracusa_w_neureka", "PULPOpen_iDMA", "PULPOpen", "Snitch", "Chimera"]
