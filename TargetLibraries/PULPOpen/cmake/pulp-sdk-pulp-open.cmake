...
set(PULP_OPEN_UART_COMPILE_FLAGS
  -DPOS_CONFIG_IO_UART=${FPGA_TARGET}
...
set(PULP_SDK_COMPILE_FLAGS ${PULP_OPEN_COMPILE_FLAGS} ${PULP_SDK_BASE_COMPILE_FLAGS} ${PULP_OPEN_UART_COMPILE_FLAGS} -D__PLATFORM__=ARCHI_PLATFORM_${SDK_PLATFORM} -D__PLATFORM_${SDK_PLATFORM}__)
